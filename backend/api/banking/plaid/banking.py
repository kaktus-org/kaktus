...
class PlaidBanking(Banking):
    ...
    def get_link_token_from_plaid() -> dict:
        ...
        response: LinkTokenCreateResponse = PlaidConfig.client.link_token_create(request)
    ...
    def get_access_token_from_plaid(public_token: str) -> dict:
        ...
        response: ItemPublicTokenExchangeResponse = PlaidConfig.client.item_public_token_exchange(request)
